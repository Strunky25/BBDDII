...
$consulta = "SELECT DISTINCT contingut.idContingut, titol, url, nomCategoria FROM usuari JOIN R_Contingut_TipusUsuari ON usuari.tipusUsuari = R_Contingut_TipusUsuari.tipusUsuari JOIN contingut ON contingut.nomCategoria IN (SELECT nomCategoria from R_Categoria_Favorita JOIN Contracte ON contracte.nomUsuari = '$nomUsuari' AND contracte.idContracte = R_Categoria_Favorita.idContracte) AND R_Contingut_TipusUsuari.idContingut = contingut.idContingut";
